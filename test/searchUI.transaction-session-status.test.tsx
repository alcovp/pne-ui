...
describe('SearchUI transaction-session-status Selenium contract', () => {
    ...
    it('scopes native triggers, restored raw values, and detached panels across two instances', async () => {
        ...
        expect(firstPanel.getAttribute('aria-label')).toBe('react.searchUI.addSessionStatusTitle')
        expect(secondPanel.getAttribute('aria-label')).toBe('react.searchUI.addSessionStatusTitle')
